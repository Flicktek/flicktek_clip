...
// except for the ones that make the content appear under the system bars.
    ...
    private NotificationMonitor mNotifications;
    ...
    private void launchNotificationService() {
        mServiceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                Log.d("NotificationService", "NLS Started");
                NotificationMonitor.ServiceBinder binder = (NotificationMonitor.ServiceBinder) service;
                mNotifications = binder.getService();
                mNotifications.onServiceConnected();
            }
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mNotifications.getCurrentInterruptionFilter() == mNotifications.INTERRUPTION_FILTER_NONE) {
                    //set all
                    b.setBackground(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_ring_volume));
                    mNotifications.requestInterruptionFilter(mNotifications.INTERRUPTION_FILTER_ALL);
                    ...
                    mNotifications.requestInterruptionFilter(mNotifications.INTERRUPTION_FILTER_NONE);
                } else {
                    //set priority
                    b.setBackground(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_ring_priority));
                    mNotifications.requestInterruptionFilter(mNotifications.INTERRUPTION_FILTER_PRIORITY);
                }
            }
        });
        */
    ...
    public void onStartNotificationsActivityClick(View view) {
        Log.v(TAG, "Launch notifications");
    ...
    public void onStartSlidesActivityClick(View view) {
        ...
        bundle.putString("launch", "com.flicktek.clip.slides");
        startIntent.putExtras(bundle);
        startIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(startIntent);
    }
